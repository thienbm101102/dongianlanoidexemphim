...
const app = {
    ...
    playVideo(m3u8Url, embedUrl) {
        ...
        if (Hls.isSupported()) {
            ...
            // ===============================================
            // BỘ LỌC QUẢNG CÁO TRỰC TIẾP (KHÔNG CẦN WORKER)
            // ===============================================
            ...
            // Tải link gốc từ API NguonC (Trình duyệt sẽ tự động cắt quảng cáo)
            ...
            // Chế độ dự phòng cho Safari / iOS (Trình duyệt Apple không cho can thiệp HLS)
            video.src = m3u8Url;
